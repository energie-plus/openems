...
@interface Config {
	...
	@AttributeDefinition(name = "Feed-in limitation", description = "Enable hardware feed-in limitation (works even when battery is full)")
	boolean feedPowerEnable() default false;

	@AttributeDefinition(name = "Feed-in limit [W]", description = "Maximum grid feed-in power in [W]; only used when feed-in limitation is enabled")
